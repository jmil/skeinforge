...
def getChainGcode( fileName, gcodeText, stretchPreferences = None ):
	...
	if not gcodec.isProcedureDone( gcodeText, 'cool' ):
		gcodeText = cool.getChainGcode( fileName, gcodeText )
	return getGcode( gcodeText, stretchPreferences )

def getGcode( gcodeText, stretchPreferences = None ):
...
def writeOutput( fileName = '' ):
	...
	stretchGcode = getChainGcode( fileName, '', stretchPreferences )
	if stretchGcode == '':
		return
