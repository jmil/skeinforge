...
def getChainGcode( fileName, gcodeText, wipePreferences = None ):
	...
	if not gcodec.isProcedureDone( gcodeText, 'hop' ):
		gcodeText = hop.getChainGcode( fileName, gcodeText )
	return getGcode( gcodeText, wipePreferences )

def getGcode( gcodeText, wipePreferences = None ):
...
def writeOutput( fileName = '' ):
	...
	wipeGcode = getChainGcode( fileName, '', wipePreferences )
	if wipeGcode == '':
		return
