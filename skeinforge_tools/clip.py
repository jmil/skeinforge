...
def getChainGcode( fileName, gcodeText, loopTailorPreferences = None ):
	...
	if not gcodec.isProcedureDone( gcodeText, 'comb' ):
		gcodeText = comb.getChainGcode( fileName, gcodeText )
	return getGcode( gcodeText, loopTailorPreferences )

def getGcode( gcodeText, loopTailorPreferences = None ):
...
def writeOutput( fileName = '' ):
	...
	loopTailorGcode = getChainGcode( fileName, '', loopTailorPreferences )
	if loopTailorGcode == '':
		return
