...
def getChainGcode( fileName, gcodeText, coolPreferences = None ):
	...
	if not gcodec.isProcedureDone( gcodeText, 'clip' ):
		gcodeText = clip.getChainGcode( fileName, gcodeText )
	return getGcode( gcodeText, coolPreferences )

def getGcode( gcodeText, coolPreferences = None ):
...
def writeOutput( fileName = '' ):
	...
	coolGcode = getChainGcode( fileName, '', coolPreferences )
	if coolGcode == '':
		return
