...
def getChainGcode( fileName, gcodeText, towerPreferences = None ):
	...
	if not gcodec.isProcedureDone( gcodeText, 'raft' ):
		gcodeText = raft.getChainGcode( fileName, gcodeText )
	return getGcode( gcodeText, towerPreferences )

def getGcode( gcodeText, towerPreferences = None ):
...
def writeOutput( fileName = '' ):
	...
	towerGcode = getChainGcode( fileName, '', towerPreferences )
	if towerGcode == '':
		return
