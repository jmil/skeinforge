...
def getChainGcode( fileName, gcodeText, oozebanePreferences = None ):
	...
	if not gcodec.isProcedureDone( gcodeText, 'wipe' ):
		gcodeText = wipe.getChainGcode( fileName, gcodeText )
	return getGcode( gcodeText, oozebanePreferences )

def getGcode( gcodeText, oozebanePreferences = None ):
...
def writeOutput( fileName = '' ):
	...
	oozebaneGcode = getChainGcode( fileName, '', oozebanePreferences )
	if oozebaneGcode == '':
		return
