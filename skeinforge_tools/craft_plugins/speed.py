...
def getCraftedText( fileName, text = '', speedPreferences = None ):
	"Speed the file or text."
	return getCraftedTextFromText( gcodec.getTextIfEmpty( fileName, text ), speedPreferences )

def getCraftedTextFromText( gcodeText, speedPreferences = None ):
