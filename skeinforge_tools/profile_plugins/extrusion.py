...
def getCraftSequence():
	...
	return 'carve,preface,widen,inset,fill,multiply,speed,raft,chamber,tower,jitter,comb,clip,cool,stretch,hop,wipe,oozebane,splodge,home,lash,fillet,unpause,export'.split( ',' )
