...
def getChainGcode( fileName, gcodeText, combPreferences = None ):
	...
	if not gcodec.isProcedureDone( gcodeText, 'tower' ):
		gcodeText = tower.getChainGcode( fileName, gcodeText )
	return getGcode( gcodeText, combPreferences )

def getGcode( gcodeText, combPreferences = None ):
...
def writeOutput( fileName = '' ):
	...
	combGcode = getChainGcode( fileName, '', combPreferences )
	if combGcode == '':
		return
