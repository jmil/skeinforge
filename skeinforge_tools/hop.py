...
def getChainGcode( fileName, gcodeText, hopPreferences = None ):
	...
	if not gcodec.isProcedureDone( gcodeText, 'stretch' ):
		gcodeText = stretch.getChainGcode( fileName, gcodeText )
	return getGcode( gcodeText, hopPreferences )

def getGcode( gcodeText, hopPreferences = None ):
...
def writeOutput( fileName = '' ):
	...
	hopGcode = getChainGcode( fileName, '', hopPreferences )
	if hopGcode == '':
		return
